...
const Footer = () => {
    return (
        <div className='bg-green-950 opacity-90 text-white 
        border text-center pt-20 pb-0 mb-0'>
            <div className='space-y-3 max-w-[960px] mx-auto'>
                ...
                <div className='flex justify-between items-center py-4 border-t-1 border-green-300'>
